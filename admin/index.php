...
<head>
  <title>Admin - php inventory management system</title>
  <meta charset="UTF-8" />
...
<body>
  ...
  if (isset($_POST["submit1"])) 
  {
      ...
      $count=0;
      $res=mysqli_query($link, "select * from user_registration where username='$username' && password='$password' && status='active' && role='admin'");
